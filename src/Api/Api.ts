...
const API: any = {
  addTodo: (payload: {
    ...
    return fetch(
      `https://backend-helpua-app.herokuapp.com//todo/todo/addtask`,
      {
        method: "POST",
        headers: {
  ...
  fetchTodo: () => {
    return fetch(
      `https://backend-helpua-app.herokuapp.com//todo/todo/fetchtodo`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  toggleTodo: (payload: {
    ...
    return fetch(
      `https://backend-helpua-app.herokuapp.com//todo/todo/toggletodo/:${payload.id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  showModal: (payload: { id: string; modalStatus: boolean }) => {
    return fetch(
      `https://backend-helpua-app.herokuapp.com//todo/todo/showmodaltodo/:${payload.id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
